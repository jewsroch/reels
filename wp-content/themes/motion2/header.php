...
<link rel="shortcut icon" href="/wp-content/themes/motion2/images/favicon.ico" />
...
<div id="header">
	<div id="logo">
		<a href="<?php echo get_option( 'home' ); ?>/"><img src="http://www.comingoffthereels.com/wp-content/themes/motion2/images/reelsheader.png"></a> <!--alt="<?php echo esc_attr( get_bloginfo( 'display' ) ); ?>" /></a>
